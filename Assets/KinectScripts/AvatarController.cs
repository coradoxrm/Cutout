...
//								(fNewDistance - fFootDistanceInitial), fFootDistance, fLastTgtY, targetPos.y, fFootDistanceTime));
        ...
        //if (bodyRoot != null)
        //{
        //    targetPos.x = bodyRoot.position.x;
        //}
        //else
        //{
        ...
        //if (bodyRoot != null)
        //{
        //    targetPos.z = bodyRoot.position.z;
        //}
        //else
        //{
...
//		else
	...
	protected Vector3 Kinect2AvatarPos(Vector3 jointPosition, bool bMoveVertically)
	{
		...
		if(offsetNode != null)
		{
            ...
            //newPosition = offsetNode.transform.position;
            newPosition = new Vector3(offsetNode.transform.position.x, newPosition.y, offsetNode.transform.position.z);
		}
